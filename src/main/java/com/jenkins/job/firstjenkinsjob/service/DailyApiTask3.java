...
@Component
@ConditionalOnProperty(name = "job.name", havingValue = "dailyApiCall3")
public class DailyApiTask3 implements CommandLineRunner {

    private final ApiService apiService;
    private final ObjectMapper mapper = new ObjectMapper();

    public DailyApiTask3(ApiService apiService) {
